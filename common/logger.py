...
class Log:
  ...
  def before_error() -> None:
    ...
    adjusted_console_options: ConsoleOptions = Log._console.options.copy().update(width=Log._console.options.size.width - 8)
    ...
    stack_segments = list(Log._console.render(traceback, adjusted_console_options))[:-2]
