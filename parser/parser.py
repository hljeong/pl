...
def parse_a(parser: ASTParser) -> ASTNode:
  node: ASTNode = ASTNode('a')
  while not parser.at_end():
    node.add_child('instruction', parser.parse('instruction'))

def parse_instruction(parser: ASTParser) -> ASTNode:
  node: ASTNode = ASTNode('instruction')

a_node_parsers: dict[str, Callable[[ASTParser], ASTNode]] = {
  'a': parse_a,
}
...
class ASTParser:
  ...
  def parse(self, node_type: str) -> ASTNode:
