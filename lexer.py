...
LeftParenthesis: type[Token] = Token.define("LeftParenthesis", r"\(")
RightParenthesis: type[Token] = Token.define("RightParenthesis", r"\)")
LeftBracket: type[Token] = Token.define("LeftBracket", r"\[")
RightBracket: type[Token] = Token.define("RightBracket", r"\]")
LeftBrace: type[Token] = Token.define("LeftBrace", r"\{")
RightBrace: type[Token] = Token.define("RightBrace", r"\}")
LeftAngleBracket: type[Token] = Token.define("LeftAngleBracket", r"<")
RightAngleBracket: type[Token] = Token.define("RightAngleBracket", r">")
...
Colon: type[Token] = Token.define("Colon", r":")
Semicolon: type[Token] = Token.define("Semicolon", r";")
...
class Lexer:
    ...
    class Instance:
        ...
        def lex_tokens(self, token_types: list[type[Token]]) -> list[Token]:
            result: list[Token] = []
            self.skip_whitespace()
            while self.src[self.pos] != "eof":
                result.append(self.parse_token(token_types))
            return result
